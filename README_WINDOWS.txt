Beebem for Microsoft Windows (24 June 1997)
============================
...
The emulator uses the path from its executable to find these directories so
it should always find the files as long as the executable is placed in the
directory above them.  You do not need to worry about setting up paths if
you create a Win95 shortcut to BeebEm.
