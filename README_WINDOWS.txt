BeebEm for Microsoft Windows (20 Jan 1998)
============================
...
to the Windows port:
  ...
  Mike Wyatt (mikebuk@aol.com) - V0.7 to V0.9 features
...
AMX mouse support - Simply maps your Windows mouse movements to AMX mouse
  movements.

DirectX screen updates - DirectX gives faster screen updates and makes a
  full screen option possible.  Strangely, DirectX is not always faster than
  standard methods when using the smaller window sizes (perhaps I've cocked
